...
function addToPlan(action) {
	...
	switch(action) {
		case 'add':
			...
			tr += 'Add : ' + entry_dn
				+ '<input type="hidden" id="form_test_plan_action-' + index_plan + '" value="' + action + '">'
				+ '<input type="hidden" id="form_test_plan_entry-dn-' + index_plan + '" value="' + entry_dn + '">';
			break;
		...
		case 'compare':
			...
			tr += 'Compare : ' + entry_dn + ' | ' + filter
				+ '<input type="hidden" id="form_test_plan_action-' + index_plan + '" value="' + action + '">'
				+ '<input type="hidden" id="form_test_plan_entry-dn-' + index_plan + '" value="' + entry_dn + '">'
				+ '<input type="hidden" id="form_test_plan_filter-' + index_plan + '" value="' + filter + '">';
			break;
		...
		case 'modify':
			...
			tr += 'Modify : ' + entry_dn + ' | ' + attribute + ' | ' + value + ' | ' + opcode
				+ '<input type="hidden" id="form_test_plan_action-' + index_plan + '" value="' + action + '">'
				+ '<input type="hidden" id="form_test_plan_entry-dn-' + index_plan + '" value="' + entry_dn + '">'
				+ '<input type="hidden" id="form_test_plan_attribute-' + index_plan + '" value="' + attribute + '">'
				+ '<input type="hidden" id="form_test_plan_value-' + index_plan + '" value="' + value + '">'
				+ '<input type="hidden" id="form_test_plan_opcode-' + index_plan + '" value="' + opcode + '">';
			break;
		...
		case 'rename':
			...
			tr += 'Rename : ' + old_entry_dn + ' | ' + new_entry_dn
				+ '<input type="hidden" id="form_test_plan_action-' + index_plan + '" value="' + action + '">'
				+ '<input type="hidden" id="form_test_plan_old-entry-dn-' + index_plan + '" value="' + old_entry_dn + '">'
				+ '<input type="hidden" id="form_test_plan_new-entry-dn-' + index_plan + '" value="' + new_entry_dn + '">';
			break;
		...
		case 'search':
			...
			tr += 'Search : ' + base + ' | ' + filter + '|' + scope
				+ '<input type="hidden" id="form_test_plan_action-' + index_plan + '" value="' + action + '">'
				+ '<input type="hidden" id="form_test_plan_base-' + index_plan + '" value="' + base + '">'
				+ '<input type="hidden" id="form_test_plan_filter' + index_plan + '" value="' + filter + '">'
				+ '<input type="hidden" id="form_test_plan_scope' + index_plan + '" value="' + scope + '">';
			break;
